...
Vendored (skill-only, MIT-licensed) from [JuliusBrussee/caveman](https://github.com/JuliusBrussee/caveman) — `skills/caveman/`. No proxy, engine, or telemetry from that project is installed here.
